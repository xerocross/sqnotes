...
def describe_sqnotes_initialization():
    ...
    @patch.object(UserConfigurationHelper, 'set_global_to_user_config', do_nothing)
...
def describe_get_is_initialized():
    ...
    def describe_initialized_in_config_is_yes():
        ...
        @patch.object(UserConfigurationHelper, 'get_global_from_user_config', just_return('yes'))
        def it_returns_true(
                                sqnotes_obj : SQNotes
                            ):
    ...
    def describe_initialized_in_config_is_none():
        ...
        @patch.object(UserConfigurationHelper, 'get_global_from_user_config', just_return(None))
